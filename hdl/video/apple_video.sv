...
module apple_video #(
    ...
    // Videx character ROM — only instantiated when VIDEX_SUPPORT is enabled (1 pROM block)
    // Half-size ROM: 128 chars × 16 scanlines = 2 KB (saves 1 BSRAM block vs full 4 KB)
    // Chars 0x80-0xFF are bitwise inverse of 0x00-0x7F, generated by XOR at pixel capture
