...
echo "  3. gowin_pack -d GW2A-18C -o a2n20v2.fs a2n20v2_pnr.json"
echo ""
echo "  To flash to Tang Nano 20K (use openFPGALoader, not Gowin Programmer):"
echo "  4. openfpgaloader -b tangnano20k -f a2n20v2.fs"
